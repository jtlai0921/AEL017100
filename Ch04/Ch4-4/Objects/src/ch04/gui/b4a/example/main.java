...
_s.Age = anywheresoftware.b4a.keywords.Common.Rnd((int)(18),(int)(36));
 //BA.debugLineNum = 49;BA.debugLine="Students.Add(s)";
_students.Add((Object)(_s));
 }
};
 };
 //BA.debugLineNum = 52;BA.debugLine="Students.SortType(\"Age\", True)  ' 排序";
_students.SortType("Age",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 53;BA.debugLine="For i = 0 To Students.Size - 1";
{
final double step27 = 1;
final double limit27 = (int)(_students.getSize()-1);
for (_i = (int)(0); (step27 > 0 && _i <= limit27) || (step27 < 0 && _i >= limit27); _i += step27) {
 //BA.debugLineNum = 54;BA.debugLine="Dim s As Student";
_s = new ch04.gui.b4a.example.main._student();
 //BA.debugLineNum = 55;BA.debugLine="s = Students.Get(i)";
_s = (ch04.gui.b4a.example.main._student)(_students.Get(_i));
 //BA.debugLineNum = 56;BA.debugLine="out = out & s.Name & \"-\"";
_out = _out+_s.Name+"-";
 //BA.debugLineNum = 57;BA.debugLine="out = out & s.Age & CRLF";
