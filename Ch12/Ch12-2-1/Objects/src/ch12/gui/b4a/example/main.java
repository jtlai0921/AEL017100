...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="Activity.Title = \"小時鐘\"";
mostCurrent._activity.setTitle((Object)("小時鐘"));
 //BA.debugLineNum = 28;BA.debugLine="count = 1";
_count = (int)(1);
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Dim lblTime As Label";
mostCurrent._lbltime = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Dim lblCounter As Label";
mostCurrent._lblcounter = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim count As Int";
_count = 0;
...
long _now = 0L;
 //BA.debugLineNum = 49;BA.debugLine="Sub ShowTime";
 //BA.debugLineNum = 50;BA.debugLine="Dim now As Long";
_now = 0L;
 //BA.debugLineNum = 51;BA.debugLine="DateTime.DateFormat = \"h:mm:ss a\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("h:mm:ss a");
 //BA.debugLineNum = 52;BA.debugLine="now = DateTime.now";
_now = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 53;BA.debugLine="lblTime.Text = DateTime.Time(now)";
mostCurrent._lbltime.setText((Object)(anywheresoftware.b4a.keywords.Common.DateTime.Time(_now)));
 //BA.debugLineNum = 54;BA.debugLine="End Sub";
return "";
}
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 44;BA.debugLine="ShowTime";
_showtime();
 //BA.debugLineNum = 45;BA.debugLine="count = count + 1";
_count = (int)(_count+1);
 //BA.debugLineNum = 46;BA.debugLine="lblCounter.Text = count";
mostCurrent._lblcounter.setText((Object)(_count));
