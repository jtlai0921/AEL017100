...
public class stackedbarchart extends Activity implements B4AActivity{
	public static stackedbarchart mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ch12.gui.b4a.example", "ch12.gui.b4a.example.stackedbarchart");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (stackedbarchart).");
				p.finish();
			}
		}
		if (!includeTitle) {
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ch12.gui.b4a.example", "ch12.gui.b4a.example.stackedbarchart");
        ...
        BA.LogInfo("** Activity (stackedbarchart) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (stackedbarchart) Resume **");
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (stackedbarchart) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
ch12.gui.b4a.example.charts._graph _g = null;
 ...
 //BA.debugLineNum = 17;BA.debugLine="Activity.Title = \"顯示堆疊長條圖\"";
mostCurrent._activity.setTitle((Object)("顯示堆疊長條圖"));
...
_bd.BarsWidth = anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(15));
 //BA.debugLineNum = 26;BA.debugLine="BD.Stacked = True  ' 是堆疊長條圖";
...
_g.Initialize();
 //BA.debugLineNum = 38;BA.debugLine="G.Title = \"業績堆疊長條圖\"";
_g.Title = "業績堆疊長條圖";
...
_g.YStart = (float)(0);
 //BA.debugLineNum = 42;BA.debugLine="G.YEnd = 1500  ' Y軸最大值";
_g.YEnd = (float)(1500);
 //BA.debugLineNum = 43;BA.debugLine="G.YInterval = 200  ' 增量";
