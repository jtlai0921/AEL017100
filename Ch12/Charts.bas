...
Sub drawGraph (G As Graph, Canvas As Canvas, Target As View, Points As List, Bars As Boolean, BarsWidth As Int)
	...
	G.GI = GI
	GI.Initialize
	GI.maxY = 40dip											' top margin
	GI.originX = 50dip									' left margin
	GI.originY = Target.Height - 60dip	' 60dip = right margin
	GI.gw = Target.Width - 70dip				' graph width 70dip = bottom margin
