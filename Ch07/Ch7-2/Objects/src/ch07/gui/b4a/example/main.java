...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 30;BA.debugLine="Activity.Title = \"匯率轉換程式\"";
mostCurrent._activity.setTitle((Object)("匯率轉換程式"));
 //BA.debugLineNum = 31;BA.debugLine="edtAmount.Text = \"1000\"";
mostCurrent._edtamount.setText((Object)("1000"));
 //BA.debugLineNum = 33;BA.debugLine="spnType.Add(\"美金\")";
mostCurrent._spntype.Add("美金");
 //BA.debugLineNum = 34;BA.debugLine="spnType.Add(\"日元\")";
mostCurrent._spntype.Add("日元");
 //BA.debugLineNum = 35;BA.debugLine="spnType.Add(\"人民幣\")";
...
double _amount = 0;
 ...
 //BA.debugLineNum = 57;BA.debugLine="Dim amount As Double = edtAmount.Text";
_amount = (double)(Double.parseDouble(mostCurrent._edtamount.getText()));
 //BA.debugLineNum = 59;BA.debugLine="lblOutput.Text = \"兌換成新台幣的金額: \" & (amount * rate)";
mostCurrent._lbloutput.setText((Object)("兌換成新台幣的金額: "+BA.NumberToString((_amount*_rate))));
...
mostCurrent._lbloutput = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim spnType As Spinner";
mostCurrent._spntype = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim rate As Double : rate = 29.9";
_rate = 0;
 //BA.debugLineNum = 25;BA.debugLine="Dim rate As Double : rate = 29.9";
_rate = 29.9;
...
public static String  _spntype_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub spnType_ItemClick(Position As Int, Value As Object)";
 //BA.debugLineNum = 48;BA.debugLine="Select Position";
switch (_position) {
case 0:
 //BA.debugLineNum = 49;BA.debugLine="Case 0 : rate = 29.9    ' 美金";
_rate = 29.9;
 break;
case 1:
 //BA.debugLineNum = 50;BA.debugLine="Case 1 : rate = 0.2949  ' 日元";
_rate = 0.2949;
 break;
case 2:
 //BA.debugLineNum = 51;BA.debugLine="Case 2 : rate = 4.861   ' 人民幣";
_rate = 4.861;
 break;
}
;
