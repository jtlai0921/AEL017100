...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="Activity.Title = \"啟用快速捲動圖示\"";
mostCurrent._activity.setTitle((Object)("啟用快速捲動圖示"));
 //BA.debugLineNum = 29;BA.debugLine="ListView1.FastScrollEnabled = True";
mostCurrent._listview1.setFastScrollEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 31;BA.debugLine="For i = 1 To 100";
{
final double step9 = 1;
final double limit9 = (int)(100);
for (_i = (int)(1); (step9 > 0 && _i <= limit9) || (step9 < 0 && _i >= limit9); _i += step9) {
 //BA.debugLineNum = 32;BA.debugLine="ListView1.AddSingleLine(\"項目: #\" & i)";
mostCurrent._listview1.AddSingleLine("項目: #"+BA.NumberToString(_i));
 }
};
...
public static String  _listview1_itemclick(int _position,Object _value) throws Exception{
 ...
 //BA.debugLineNum = 45;BA.debugLine="Activity.Title = Value";
