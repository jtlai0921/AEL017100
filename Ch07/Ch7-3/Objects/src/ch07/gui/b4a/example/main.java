...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 31;BA.debugLine="Activity.Title = \"度量衡轉換程式\"";
mostCurrent._activity.setTitle((Object)("度量衡轉換程式"));
 //BA.debugLineNum = 32;BA.debugLine="edtLength.Text = \"100.0\"";
...
double _result = 0;
 ...
 //BA.debugLineNum = 56;BA.debugLine="Dim length As Double = edtLength.Text";
_length = (double)(Double.parseDouble(mostCurrent._edtlength.getText()));
 //BA.debugLineNum = 57;BA.debugLine="Dim result As Double = 0.0";
_result = 0.0;
 //BA.debugLineNum = 58;BA.debugLine="If lengthType Then  ' 英吋轉公分";
if (_lengthtype) { 
 //BA.debugLineNum = 59;BA.debugLine="result = length * 2.54";
_result = _length*2.54;
 //BA.debugLineNum = 60;BA.debugLine="lblOutput.Text = \"換成公分: \" & result";
mostCurrent._lbloutput.setText((Object)("換成公分: "+BA.NumberToString(_result)));
 }else {
 //BA.debugLineNum = 62;BA.debugLine="result = length / 2.54";
_result = _length/(double)2.54;
 //BA.debugLineNum = 63;BA.debugLine="lblOutput.Text = \"換成英吋: \" & result";
mostCurrent._lbloutput.setText((Object)("換成英吋: "+BA.NumberToString(_result)));
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Dim edtLength As EditText";
...
mostCurrent._lbloutput = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim lblUnit As Label";
...
mostCurrent._button1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim lengthType As Boolean : lengthType = False";
_lengthtype = false;
 //BA.debugLineNum = 26;BA.debugLine="Dim lengthType As Boolean : lengthType = False";
...
public static String  _togglebutton1_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub ToggleButton1_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 44;BA.debugLine="If Checked Then";
if (_checked) { 
 //BA.debugLineNum = 45;BA.debugLine="lengthType = True  ' 英製";
_lengthtype = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 46;BA.debugLine="lblUnit.Text = \"英吋\"";
mostCurrent._lblunit.setText((Object)("英吋"));
 //BA.debugLineNum = 47;BA.debugLine="Button1.Text = \"轉換成公制\"";
mostCurrent._button1.setText((Object)("轉換成公制"));
 }else {
 //BA.debugLineNum = 49;BA.debugLine="lengthType = False ' 公制";
_lengthtype = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 50;BA.debugLine="lblUnit.Text = \"公分\"";
mostCurrent._lblunit.setText((Object)("公分"));
 //BA.debugLineNum = 51;BA.debugLine="Button1.Text = \"轉換成英制\"";
mostCurrent._button1.setText((Object)("轉換成英制"));
 };
