...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="Activity.Title = \"輸出連接字串\"";
mostCurrent._activity.setTitle((Object)("輸出連接字串"));
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim Label2 As Label";
mostCurrent._label2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim Label3 As Label";
mostCurrent._label3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="End Sub";
return "";
}
public static String  _label4_click() throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub Label4_Click";
 //BA.debugLineNum = 41;BA.debugLine="Label3.Text = Label1.Text & Label2.Text";
mostCurrent._label3.setText((Object)(mostCurrent._label1.getText()+mostCurrent._label2.getText()));
