...
double _w = 0;
 ...
 //BA.debugLineNum = 41;BA.debugLine="Dim h As Double = edtHeight.Text / 100.0";
_h = (double)(Double.parseDouble(mostCurrent._edtheight.getText()))/(double)100.0;
 //BA.debugLineNum = 42;BA.debugLine="Dim w As Double = edtWeight.Text";
_w = (double)(Double.parseDouble(mostCurrent._edtweight.getText()));
 //BA.debugLineNum = 43;BA.debugLine="lblOutput.Text = \"BMI: \" & (w / (h * h))";
