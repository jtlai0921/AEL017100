...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="Activity.Title = \"我的相機\"";
mostCurrent._activity.setTitle((Object)("我的相機"));
 //BA.debugLineNum = 29;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 30;BA.debugLine="MP.Initialize()";
_mp.Initialize();
 //BA.debugLineNum = 31;BA.debugLine="MP.Load(File.DirAssets, \"TakePicture.mp3\")";
_mp.Load(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"TakePicture.mp3");
 };
 //BA.debugLineNum = 33;BA.debugLine="Button1.Color = Colors.Transparent";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 42;BA.debugLine="camera1.Release()";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 37;BA.debugLine="Button1.Enabled = False";
mostCurrent._button1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 38;BA.debugLine="camera1.Initialize(pnlPreview, False, Me, \"Camera1\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 66;BA.debugLine="Button1.Enabled = False";
mostCurrent._button1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 67;BA.debugLine="camera1.TakePicture()";
mostCurrent._camera1._takepicture();
 //BA.debugLineNum = 68;BA.debugLine="MP.Play()  ' 播放音效";
_mp.Play();
 //BA.debugLineNum = 69;BA.debugLine="End Sub";
return "";
}
public static String  _camera1_picturetaken(byte[] _data) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub Camera1_PictureTaken(Data() As Byte)";
 //BA.debugLineNum = 59;BA.debugLine="camera1.SavePictureToFile(Data, File.DirRootExternal, \"Pic1.jpg\")";
mostCurrent._camera1._savepicturetofile(_data,anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Pic1.jpg");
 //BA.debugLineNum = 60;BA.debugLine="camera1.StartPreview()  ' 重新啟動預覽";
mostCurrent._camera1._startpreview();
 //BA.debugLineNum = 61;BA.debugLine="ToastMessageShow(\"照片已儲存: \" & File.Combine(File.DirRootExternal, \"Pic.jpg\"), True)";
...
public static String  _camera1_ready(boolean _success) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub Camera1_Ready(Success As Boolean)";
 //BA.debugLineNum = 46;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 48;BA.debugLine="camera1.SetJpegQuality(90) ' 圖檔品質";
mostCurrent._camera1._setjpegquality((int) (90));
 //BA.debugLineNum = 49;BA.debugLine="camera1.CommitParameters()";
mostCurrent._camera1._commitparameters();
 //BA.debugLineNum = 50;BA.debugLine="camera1.StartPreview()     ' 開始預覽";
mostCurrent._camera1._startpreview();
 //BA.debugLineNum = 51;BA.debugLine="Button1.Enabled = True";
mostCurrent._button1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 53;BA.debugLine="ToastMessageShow(\"無法開啟相機...\", True)";
...
public static void initializeProcessGlobals() {
 ...
 //BA.debugLineNum = 20;BA.debugLine="Dim camera1 As CameraExClass";
mostCurrent._camera1 = new ch16.gui.b4a.example.cameraexclass();
 //BA.debugLineNum = 21;BA.debugLine="Dim pnlPreview As Panel";
...
mostCurrent._button1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim chkAutoFocus As CheckBox";
