...
public class cameraexclass extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ch16.gui.b4a.example.cameraexclass");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "ch16.gui.b4a.example.cameraexclass",
                    ba);
                return;
		    }
        }
...
public ch16.gui.b4a.example.main _main = null;
...
_front = false;
 //BA.debugLineNum = 13;BA.debugLine="Type CameraInfoAndId (CameraInfo As Object, Id As Int)";
;
...
_r.Target = (Object)(_cam);
 //BA.debugLineNum = 268;BA.debugLine="r.RunMethod2(\"releaseCameras\", True, \"java.lang.boolean\")";
...
_r.Target = _nativecam;
 //BA.debugLineNum = 139;BA.debugLine="r.RunMethod4(\"setParameters\", Array As Object(parameters), Array As String(\"android.hardware.Camera$Parameters\"))";
_r.RunMethod4("setParameters",new Object[]{_parameters},new String[]{"android.hardware.Camera$Parameters"});
 } 
       catch (Exception e120) {
			ba.setLastException(e120); //BA.debugLineNum = 141;BA.debugLine="ToastMessageShow(\"Error setting parameters.\", True)";
...
public ch16.gui.b4a.example.cameraexclass._camerainfoandid  _findcamera(boolean _frontcamera) throws Exception{
ch16.gui.b4a.example.cameraexclass._camerainfoandid _ci = null;
Object _camerainfo = null;
int _cameravalue = 0;
int _numberofcameras = 0;
int _i = 0;
 //BA.debugLineNum = 35;BA.debugLine="Private Sub FindCamera (frontCamera As Boolean) As CameraInfoAndId";
 //BA.debugLineNum = 36;BA.debugLine="Dim ci As CameraInfoAndId";
_ci = new ch16.gui.b4a.example.cameraexclass._camerainfoandid();
...
_cameravalue = 0;
 //BA.debugLineNum = 39;BA.debugLine="If frontCamera Then cameraValue = 1 Else cameraValue = 0";
if (_frontcamera) { 
_cameravalue = (int) (1);}
else {
_cameravalue = (int) (0);};
 //BA.debugLineNum = 40;BA.debugLine="cameraInfo = r.CreateObject(\"android.hardware.Camera$CameraInfo\")";
_camerainfo = _r.CreateObject("android.hardware.Camera$CameraInfo");
 //BA.debugLineNum = 41;BA.debugLine="Dim numberOfCameras As Int = r.RunStaticMethod(\"android.hardware.Camera\", \"getNumberOfCameras\", Null, Null)";
...
for (_i = (int) (0); (step34 > 0 && _i <= limit34) || (step34 < 0 && _i >= limit34); _i = ((int)(0 + _i + step34))) {
 //BA.debugLineNum = 43;BA.debugLine="r.RunStaticMethod(\"android.hardware.Camera\", \"getCameraInfo\", Array As Object(i, cameraInfo), _ 			Array As String(\"java.lang.int\", \"android.hardware.Camera$CameraInfo\"))";
...
_r.Target = _parameters;
 //BA.debugLineNum = 260;BA.debugLine="r.RunMethod4(\"getFocusDistances\", Array As Object(F), Array As String(\"[F\"))";
...
public ch16.gui.b4a.example.cameraexclass._camerasize  _getpicturesize() throws Exception{
ch16.gui.b4a.example.cameraexclass._camerasize _cs = null;
...
_cs = new ch16.gui.b4a.example.cameraexclass._camerasize();
...
public ch16.gui.b4a.example.cameraexclass._camerasize  _getpreviewsize() throws Exception{
ch16.gui.b4a.example.cameraexclass._camerasize _cs = null;
...
public ch16.gui.b4a.example.cameraexclass._camerasize[]  _getsupportedpicturessizes() throws Exception{
...
_r.Target = _parameters;
 //BA.debugLineNum = 156;BA.debugLine="Dim list1 As List = r.RunMethod(\"getSupportedPictureSizes\")";
...
_cs = new ch16.gui.b4a.example.cameraexclass._camerasize[_list1.getSize()];
{
int d0 = _cs.length;
for (int i0 = 0;i0 < d0;i0++) {
_cs[i0] = new ch16.gui.b4a.example.cameraexclass._camerasize();
}
}
;
...
innerInitialize(_ba);
int _id = 0;
 //BA.debugLineNum = 18;BA.debugLine="Public Sub Initialize (Panel1 As Panel, FrontCamera As Boolean, TargetModule As Object, EventName As String)";
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 216;BA.debugLine="Public Sub PreviewImageToJpeg(data() As Byte, quality As Int) As Byte()";
...
_r.Target = _size;
 //BA.debugLineNum = 222;BA.debugLine="Dim width = r.GetField(\"width\"), height = r.GetField(\"height\") As Int";
_width = (int)(BA.ObjectToNumber(_r.GetField("width")));
_height = (int)(BA.ObjectToNumber(_r.GetField("height")));
 //BA.debugLineNum = 223;BA.debugLine="Dim yuvImage As Object = r.CreateObject2(\"android.graphics.YuvImage\", _ 		Array As Object(data, previewFormat, width, height, Null), _ 		Array As String(\"[B\", \"java.lang.int\", \"java.lang.int\", \"java.lang.int\", \"[I\"))";
...
_rect1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 228;BA.debugLine="rect1.Initialize(0, 0, r.RunMethod(\"getWidth\"), r.RunMethod(\"getHeight\"))";
...
_out.InitializeToBytesArray((int) (100));
 //BA.debugLineNum = 231;BA.debugLine="r.RunMethod4(\"compressToJpeg\", Array As Object(rect1, quality, out), _ 		Array As String(\"android.graphics.Rect\", \"java.lang.int\", \"java.io.OutputStream\"))";
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 120;BA.debugLine="Public Sub SavePictureToFile(Data() As Byte, Dir As String, FileName As String)";
 //BA.debugLineNum = 121;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, FileName, False)";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
...
_modes = _getsupportedfocusmodes();
 //BA.debugLineNum = 243;BA.debugLine="If modes.IndexOf(\"continuous-picture\") > -1 Then";
...
_setfocusmode("continuous-video");
 ...
 //BA.debugLineNum = 248;BA.debugLine="Log(\"Continuous focus mode is not available\")";
...
_r.Target = _r.RunMethod("getRotation");
 //BA.debugLineNum = 61;BA.debugLine="Dim previewResult, result, degrees As Int = r.target * 90";
_previewresult = 0;
_result = 0;
...
_previewresult = (int) ((360-_previewresult)%360);
 ...
 //BA.debugLineNum = 70;BA.debugLine="previewResult = (orientation - degrees + 360) Mod 360";
...
_r.Target = _nativecam;
 //BA.debugLineNum = 75;BA.debugLine="r.RunMethod2(\"setDisplayOrientation\", previewResult, \"java.lang.int\")";
...
_r.Target = _parameters;
 //BA.debugLineNum = 77;BA.debugLine="r.RunMethod2(\"setRotation\", result, \"java.lang.int\")";
...
_r.Target = _parameters;
 //BA.debugLineNum = 178;BA.debugLine="r.RunMethod2(\"setFlashMode\", Mode, \"java.lang.String\")";
...
_r.Target = _parameters;
 //BA.debugLineNum = 254;BA.debugLine="r.RunMethod2(\"setFocusMode\", Mode, \"java.lang.String\")";
...
_r.Target = _parameters;
 //BA.debugLineNum = 173;BA.debugLine="r.RunMethod2(\"setJpegQuality\", Quality, \"java.lang.int\")";
...
public String  _setparameter(String _key,String _value) throws Exception{
 //BA.debugLineNum = 126;BA.debugLine="Public Sub SetParameter(Key As String, Value As String)";
 //BA.debugLineNum = 127;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 128;BA.debugLine="r.RunMethod3(\"set\", Key, \"java.lang.String\", Value, \"java.lang.String\")";
...
public String  _setpicturesize(int _width,int _height) throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Public Sub SetPictureSize(Width As Int, Height As Int)";
 //BA.debugLineNum = 167;BA.debugLine="r.target = parameters";
_r.Target = _parameters;
 //BA.debugLineNum = 168;BA.debugLine="r.RunMethod3(\"setPictureSize\", Width, \"java.lang.int\", Height, \"java.lang.int\")";
