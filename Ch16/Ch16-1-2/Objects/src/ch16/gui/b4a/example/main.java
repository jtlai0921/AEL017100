...
public ch16.gui.b4a.example.shake _shake = null;
...
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 26;BA.debugLine="Activity.Title = \"搖晃播放音樂\"";
mostCurrent._activity.setTitle((Object)("搖晃播放音樂"));
 //BA.debugLineNum = 27;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 28;BA.debugLine="sensor.Initialize(sensor.TYPE_ACCELEROMETER)";
_sensor.Initialize(_sensor.TYPE_ACCELEROMETER);
 //BA.debugLineNum = 29;BA.debugLine="Shake.CallBackActivity = \"Main\" ' 指定處理搖晃事件的活動";
mostCurrent._shake._callbackactivity = "Main";
 //BA.debugLineNum = 30;BA.debugLine="MP.Initialize()";
_mp.Initialize();
 //BA.debugLineNum = 31;BA.debugLine="MP.Load(File.DirAssets, \"IsawHerStandingThere.mid\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 43;BA.debugLine="sensor.StopListening()";
_sensor.StopListening(processBA);
 //BA.debugLineNum = 44;BA.debugLine="If MP.IsPlaying() Then";
if (_mp.IsPlaying()) { 
...
mostCurrent._lbloutput.setText((Object)("裝置不支援加速感測器..."));
 ...
 //BA.debugLineNum = 39;BA.debugLine="lblOutput.Text = \"請搖晃裝置播放音樂...\"";
mostCurrent._lbloutput.setText((Object)("請搖晃裝置播放音樂..."));
...
shake._process_globals();
 ...
 //BA.debugLineNum = 21;BA.debugLine="Dim lblOutput As Label";
...
public static String  _sensor_sensorchanged(float[] _values) throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub sensor_SensorChanged(Values() As Float)";
 //BA.debugLineNum = 50;BA.debugLine="Shake.HandleSensorEvent(Values)";
...
public static String  _shakeevent() throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Sub ShakeEvent";
 //BA.debugLineNum = 54;BA.debugLine="Activity.Color = Colors.RGB(Rnd(0, 255), Rnd(0, 255), Rnd(0, 255))";
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB(anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (255)),anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (255)),anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (255))));
 //BA.debugLineNum = 55;BA.debugLine="MP.Play()";
_mp.Play();
 //BA.debugLineNum = 56;BA.debugLine="MP.Looping = False";
_mp.setLooping(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 57;BA.debugLine="lblOutput.Text = \"音樂正在播放中...\"";
mostCurrent._lbloutput.setText((Object)("音樂正在播放中..."));
