...
public class webview extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ch09.gui.b4a.example", "ch09.gui.b4a.example.webview");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ch09.gui.b4a.example", "ch09.gui.b4a.example.webview");
...
mostCurrent._activity.LoadLayout("WebView",mostCurrent.activityBA);
 //BA.debugLineNum = 18;BA.debugLine="Activity.Title = \"WebView元件\"";
mostCurrent._activity.setTitle((Object)("WebView元件"));
 //BA.debugLineNum = 19;BA.debugLine="WebView1.Width = 100%x";
mostCurrent._webview1.setWidth(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float)(100),mostCurrent.activityBA));
 //BA.debugLineNum = 20;BA.debugLine="WebView1.Height = 100%y";
...
_url = "";
 //BA.debugLineNum = 25;BA.debugLine="URL = Main.URL";
_url = mostCurrent._main._url;
 //BA.debugLineNum = 26;BA.debugLine="WebView1.LoadUrl(URL)";
