...
public class webview extends Activity implements B4AActivity{
	...
	private void afterFirstLayout() {
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ch14.gui.b4a.example.webview", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
