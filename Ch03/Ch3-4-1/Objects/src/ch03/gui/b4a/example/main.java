...
String _out = "";
 ...
 //BA.debugLineNum = 43;BA.debugLine="Dim grade As Int = 85";
_grade = (int)(85);
 //BA.debugLineNum = 44;BA.debugLine="Dim out As String";
_out = "";
 //BA.debugLineNum = 46;BA.debugLine="If grade >= 60 Then";
if (_grade>=60) { 
 //BA.debugLineNum = 47;BA.debugLine="out = \"陳會安成績及格\" & CRLF";
_out = "陳會安成績及格"+anywheresoftware.b4a.keywords.Common.CRLF;
 };
 //BA.debugLineNum = 49;BA.debugLine="If grade >= 60 Then out = out & \"陳小安及格\" & CRLF";
if (_grade>=60) { 
_out = _out+"陳小安及格"+anywheresoftware.b4a.keywords.Common.CRLF;};
 //BA.debugLineNum = 51;BA.debugLine="If grade >= 60 Then";
if (_grade>=60) { 
 //BA.debugLineNum = 52;BA.debugLine="out = out & \"江小魚成績及格\" & CRLF";
_out = _out+"江小魚成績及格"+anywheresoftware.b4a.keywords.Common.CRLF;
 }else {
 //BA.debugLineNum = 54;BA.debugLine="out = out & \"江小魚成績不及格\" & CRLF";
_out = _out+"江小魚成績不及格"+anywheresoftware.b4a.keywords.Common.CRLF;
 };
