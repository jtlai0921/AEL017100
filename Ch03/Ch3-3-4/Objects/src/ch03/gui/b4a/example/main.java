...
String _out = "";
 ...
 //BA.debugLineNum = 42;BA.debugLine="Dim a = 5 > 3, b = 4 <= 2 As Boolean";
_a = 5>3;
_b = 4<=2;
 //BA.debugLineNum = 43;BA.debugLine="Dim out As String";
_out = "";
 //BA.debugLineNum = 44;BA.debugLine="out = \"Not (5 > 3) : \" & (Not (a)) & CRLF";
_out = "Not (5 > 3) : "+String.valueOf((anywheresoftware.b4a.keywords.Common.Not(_a)))+anywheresoftware.b4a.keywords.Common.CRLF;
 //BA.debugLineNum = 45;BA.debugLine="out = out & \"Not (4 <= 2): \" & (Not (b)) & CRLF";
_out = _out+"Not (4 <= 2): "+String.valueOf((anywheresoftware.b4a.keywords.Common.Not(_b)))+anywheresoftware.b4a.keywords.Common.CRLF;
 //BA.debugLineNum = 46;BA.debugLine="out = out & \"5 > 3 And 4 <= 2 : \" & (a AND b) & CRLF";
_out = _out+"5 > 3 And 4 <= 2 : "+String.valueOf((_a && _b))+anywheresoftware.b4a.keywords.Common.CRLF;
 //BA.debugLineNum = 47;BA.debugLine="out = out & \"5 > 3 Or 4 <= 2: \" & (a OR b) & CRLF";
_out = _out+"5 > 3 Or 4 <= 2: "+String.valueOf((_a || _b))+anywheresoftware.b4a.keywords.Common.CRLF;
 //BA.debugLineNum = 48;BA.debugLine="lblOutput.Text = out";
