...
try { //BA.debugLineNum = 43;BA.debugLine="Dim In As InputStream";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 44;BA.debugLine="In = File.OpenInput(File.DirInternal, \"MissingFile.txt\")";
_in = anywheresoftware.b4a.keywords.Common.File.OpenInput(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"MissingFile.txt");
 } 
       catch (Exception e18) {
			processBA.setLastException(e18); //BA.debugLineNum = 46;BA.debugLine="lblOutput.Text = LastException.Message";
mostCurrent._lbloutput.setText((Object)(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage()));
 };
