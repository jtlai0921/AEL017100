...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4i.examples.lifecycle.b4i_main");
        //anywheresoftware.b4a.pc.RapidSub.moduleToObject.put("b4i.examples.lifecycle.b4i_main", "b4i.examples.lifecycle.b4i_main");
	}
