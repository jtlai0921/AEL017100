...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4i.examples.bmi.b4i_main");
        //anywheresoftware.b4a.pc.RapidSub.moduleToObject.put("b4i.examples.bmi.b4i_main", "b4i.examples.bmi.b4i_main");
	}
...
public static RemoteObject _txtweight = RemoteObject.declareNull("B4ITextFieldWrapper");
  public Object[] GetGlobals() {
		return new Object[] {"App",b4i_main._app,"lblOutput",b4i_main._lbloutput,"NavControl",b4i_main._navcontrol,"Page1",b4i_main._page1,"txtHeight",b4i_main._txtheight,"txtWeight",b4i_main._txtweight};
}
}