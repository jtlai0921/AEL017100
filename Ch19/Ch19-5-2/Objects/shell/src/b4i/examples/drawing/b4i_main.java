...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4i.examples.drawing.b4i_main");
        //anywheresoftware.b4a.pc.RapidSub.moduleToObject.put("b4i.examples.drawing.b4i_main", "b4i.examples.drawing.b4i_main");
	}
...
public static RemoteObject _pnlgraph = RemoteObject.declareNull("B4IPanelWrapper");
public static RemoteObject _cvsgraph = RemoteObject.declareNull("B4ICanvas");
public static RemoteObject _bmp = RemoteObject.declareNull("B4IBitmap");
  public Object[] GetGlobals() {
		return new Object[] {"App",b4i_main._app,"bmp",b4i_main._bmp,"cvsGraph",b4i_main._cvsgraph,"NavControl",b4i_main._navcontrol,"Page1",b4i_main._page1,"pnlGraph",b4i_main._pnlgraph};
}
}