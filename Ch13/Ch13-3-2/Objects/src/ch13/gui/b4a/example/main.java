...
public ch13.gui.b4a.example.datewidgetservice _datewidgetservice = null;
public static String  _activity_create(boolean _firsttime) throws Exception{
 //BA.debugLineNum = 27;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 28;BA.debugLine="Msgbox(\"請在首頁新增日期小工具...\", \"首頁小工具\")";
anywheresoftware.b4a.keywords.Common.Msgbox("請在首頁新增日期小工具...","首頁小工具",mostCurrent.activityBA);
...
datewidgetservice._process_globals();
